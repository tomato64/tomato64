...
#define WIFI_DEF_PHY_BLOCK(p, band, width) \
	...
	{"wifi_phy" #p "_ifaces",	"1"			, 0 }, \
	{"wifi_phy" #p "_custom",	""			, 0 },

/* WiFi per-interface defaults (generic: disabled, no SSID, no encryption) */
#define WIFI_DEF_IFACE_BLOCK(p, i) \
	{"wifi_phy" #p "iface" #i "_enable",		"0"		, 0 }, \
	{"wifi_phy" #p "iface" #i "_mode",		"ap"		, 0 }, \
	{"wifi_phy" #p "iface" #i "_essid",		""		, 0 }, \
	{"wifi_phy" #p "iface" #i "_bssid",		""		, 0 }, \
	{"wifi_phy" #p "iface" #i "_network",		"br0"		, 0 }, \
	{"wifi_phy" #p "iface" #i "_hidden",		""		, 0 }, \
	{"wifi_phy" #p "iface" #i "_wmm",		"1"		, 0 }, \
	{"wifi_phy" #p "iface" #i "_uapsd",		"1"		, 0 }, \
	{"wifi_phy" #p "iface" #i "_encryption",	"none"		, 0 }, \
	{"wifi_phy" #p "iface" #i "_cipher",		"auto"		, 0 }, \
	{"wifi_phy" #p "iface" #i "_key",		""		, 0 }, \
	{"wifi_phy" #p "iface" #i "_isolate",		""		, 0 }, \
	{"wifi_phy" #p "iface" #i "_br_isolate",	""		, 0 }, \
...
#if defined(TOMATO64_BPIR3MINI) || defined(TOMATO64_R6S) || defined(TOMATO64_R5S)
	{ "lan_invert",			"1"				, 0 },	/* Invert Ethernet LAN ports state (0|1) */
#else
	{ "lan_invert",			"0"				, 0 },	/* Invert Ethernet LAN ports state (0|1) */
#endif /* TOMATO64_BPIR3MINI || TOMATO64_R6S || TOMATO64_R5S */
...
/* vpn */
	...
	{ "vpns3_proto",		"udp"				, 0 },
	{ "vpns3_port",			"1196"				, 0 },
	{ "vpns3_firewall",		"auto"				, 0 },
#ifdef TCONFIG_OPTIMIZE_SIZE_MORE
	{ "vpns3_crypt",		"secret"			, 0 },
#else
	{ "vpns3_crypt",		"tls"				, 0 },
#endif
...
#else
	{ "vpns3_ncp_ciphers",	"CHACHA20-POLY1305:AES-128-GCM:AES-256-GCM:AES-128-CBC:AES-256-CBC", 0 },
#endif
	{ "vpns3_digest",		"default"			, 0 },
	{ "vpns3_dhcp",			"1"				, 0 },
	{ "vpns3_r1",			"192.168.1.50"			, 0 },
	{ "vpns3_r2",			"192.168.1.55"			, 0 },
	{ "vpns3_sn",			"10.8.0.0"			, 0 },
	{ "vpns3_nm",			"255.255.255.0"			, 0 },
	{ "vpns3_local",		"10.8.0.1"			, 0 },
	...
	{ "vpns4_proto",		"udp"				, 0 },
	{ "vpns4_port",			"1197"				, 0 },
	{ "vpns4_firewall",		"auto"				, 0 },
#ifdef TCONFIG_OPTIMIZE_SIZE_MORE
	{ "vpns4_crypt",		"secret"			, 0 },
#else
	{ "vpns4_crypt",		"tls"				, 0 },
#endif
...
#else
	{ "vpns4_ncp_ciphers",	"CHACHA20-POLY1305:AES-128-GCM:AES-256-GCM:AES-128-CBC:AES-256-CBC", 0 },
#endif
	{ "vpns4_digest",		"default"			, 0 },
	{ "vpns4_dhcp",			"1"				, 0 },
	{ "vpns4_r1",			"192.168.1.50"			, 0 },
	{ "vpns4_r2",			"192.168.1.55"			, 0 },
	{ "vpns4_sn",			"10.9.0.0"			, 0 },
	{ "vpns4_nm",			"255.255.255.0"			, 0 },
	{ "vpns4_local",		"10.9.0.1"			, 0 },
