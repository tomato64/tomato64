...
#define WIFI_DEF_PHY_BLOCK(p, band, width) \
	{"wifi_phy" #p "_band",		band			}, \
	{"wifi_phy" #p "_mode",		WIFI_DEFAULT_MODE	}, \
	{"wifi_phy" #p "_channel",	"auto"			}, \
	{"wifi_phy" #p "_width",	width			}, \
	{"wifi_phy" #p "_brates",	""			}, \
	{"wifi_phy" #p "_cell_density",	"0"			}, \
	{"wifi_phy" #p "_noscan",	""			}, \
	{"wifi_phy" #p "_power",	""			}, \
	{"wifi_phy" #p "_country",	""			}, \
	{"wifi_phy" #p "_ifaces",	"1"			}, \
	{"wifi_phy" #p "_custom",	""			},

/* WiFi per-interface defaults (generic: disabled, no SSID, no encryption) */
#define WIFI_DEF_IFACE_BLOCK(p, i) \
	{"wifi_phy" #p "iface" #i "_enable",		"0"		}, \
	{"wifi_phy" #p "iface" #i "_mode",		"ap"		}, \
	{"wifi_phy" #p "iface" #i "_essid",		""		}, \
	{"wifi_phy" #p "iface" #i "_bssid",		""		}, \
	{"wifi_phy" #p "iface" #i "_network",		"br0"		}, \
	{"wifi_phy" #p "iface" #i "_hidden",		""		}, \
	{"wifi_phy" #p "iface" #i "_wmm",		"1"		}, \
	{"wifi_phy" #p "iface" #i "_uapsd",		"1"		}, \
	{"wifi_phy" #p "iface" #i "_encryption",	"none"		}, \
	{"wifi_phy" #p "iface" #i "_cipher",		"auto"		}, \
	{"wifi_phy" #p "iface" #i "_key",		""		}, \
	{"wifi_phy" #p "iface" #i "_isolate",		""		}, \
	{"wifi_phy" #p "iface" #i "_br_isolate",	""		}, \
	{"wifi_phy" #p "iface" #i "_ifname",		""		}, \
	{"wifi_phy" #p "iface" #i "_macfilter",		""		}, \
	{"wifi_phy" #p "iface" #i "_maclist",		""		}, \
	{"wifi_phy" #p "iface" #i "_custom",		""		}, \
	{"wifi_phy" #p "iface" #i "_mesh_fwding",	"1"		}, \
	{"wifi_phy" #p "iface" #i "_mesh_rssi_threshold", "0"	}, \
	{"wifi_phy" #p "iface" #i "_ieee80211r",		"0"	}, \
	{"wifi_phy" #p "iface" #i "_nasid",			""	}, \
	{"wifi_phy" #p "iface" #i "_mobility_domain",		""	}, \
	{"wifi_phy" #p "iface" #i "_reassociation_deadline",	""	}, \
	{"wifi_phy" #p "iface" #i "_ft_over_ds",		"0"	}, \
	{"wifi_phy" #p "iface" #i "_ft_psk_generate_local",	"1"	}, \
	{"wifi_phy" #p "iface" #i "_r0_key_lifetime",		""	}, \
	{"wifi_phy" #p "iface" #i "_r1_key_holder",		""	}, \
	{"wifi_phy" #p "iface" #i "_pmk_r1_push",		"0"	}, \
	{"wifi_phy" #p "iface" #i "_r0kh",			""	}, \
	{"wifi_phy" #p "iface" #i "_r1kh",			""	}, \
	{"wifi_phy" #p "iface" #i "_ieee80211k",		"0"	}, \
	{"wifi_phy" #p "iface" #i "_rrm_neighbor_report",	"1"	}, \
	{"wifi_phy" #p "iface" #i "_rrm_beacon_report",		"1"	}, \
	{"wifi_phy" #p "iface" #i "_time_advertisement",	"0"	}, \
	{"wifi_phy" #p "iface" #i "_time_zone",			""	}, \
	{"wifi_phy" #p "iface" #i "_wnm_sleep_mode",		"0"	}, \
	{"wifi_phy" #p "iface" #i "_wnm_sleep_mode_no_keys",	"0"	}, \
	{"wifi_phy" #p "iface" #i "_bss_transition",		"0"	}, \
	{"wifi_phy" #p "iface" #i "_proxy_arp",			"0"	},

/* All 16 ifaces for a given phy (all generic/disabled) */
#define WIFI_DEF_PHY_IFACES(p) \
	WIFI_DEF_IFACE_BLOCK(p, 0) \
	WIFI_DEF_IFACE_BLOCK(p, 1) \
	WIFI_DEF_IFACE_BLOCK(p, 2) \
	WIFI_DEF_IFACE_BLOCK(p, 3) \
	WIFI_DEF_IFACE_BLOCK(p, 4) \
	WIFI_DEF_IFACE_BLOCK(p, 5) \
	WIFI_DEF_IFACE_BLOCK(p, 6) \
	WIFI_DEF_IFACE_BLOCK(p, 7) \
	WIFI_DEF_IFACE_BLOCK(p, 8) \
	WIFI_DEF_IFACE_BLOCK(p, 9) \
	WIFI_DEF_IFACE_BLOCK(p, 10) \
	WIFI_DEF_IFACE_BLOCK(p, 11) \
	WIFI_DEF_IFACE_BLOCK(p, 12) \
	WIFI_DEF_IFACE_BLOCK(p, 13) \
	WIFI_DEF_IFACE_BLOCK(p, 14) \
	WIFI_DEF_IFACE_BLOCK(p, 15)

/* Ifaces 1-15 for phy0 (iface0 is defined explicitly with special defaults) */
#define WIFI_DEF_PHY0_IFACES_1_15 \
	WIFI_DEF_IFACE_BLOCK(0, 1) \
	WIFI_DEF_IFACE_BLOCK(0, 2) \
	WIFI_DEF_IFACE_BLOCK(0, 3) \
	WIFI_DEF_IFACE_BLOCK(0, 4) \
	WIFI_DEF_IFACE_BLOCK(0, 5) \
	WIFI_DEF_IFACE_BLOCK(0, 6) \
	WIFI_DEF_IFACE_BLOCK(0, 7) \
	WIFI_DEF_IFACE_BLOCK(0, 8) \
	WIFI_DEF_IFACE_BLOCK(0, 9) \
	WIFI_DEF_IFACE_BLOCK(0, 10) \
	WIFI_DEF_IFACE_BLOCK(0, 11) \
	WIFI_DEF_IFACE_BLOCK(0, 12) \
...
struct nvram_tuple router_defaults[] = {
	...
	{ "lan_invert",			"1"				},	/* Invert Ethernet LAN ports state (0|1) */
#else
	{ "lan_invert",			"0"				},	/* Invert Ethernet LAN ports state (0|1) */
#endif /* TOMATO64_BPIR3MINI || TOMATO64_R6S || TOMATO64_R5S || TOMATO64_R76S */
...
#ifdef TOMATO64
	{ "zram_enable",		"0"				},
	{ "zram_size",			"0"				},	/* 0 = auto (50% of RAM) */
	{ "zram_priority",		"100"				},
	{ "zram_comp_algo",		"lz4"				},
	{ "cpu_governor",		""				},	/* empty = use kernel default */
#endif /* TOMATO64 */
...
#else
	{ "qos_stats",			"1"				}, /* per-connection QoS statistics */
#endif /* TOMATO64 */
...
#else
	{ "http_lan_listeners",		"127"				},	/* Enable listeners: bit 0 = LAN1, bit 1 = LAN2, bit 2 = LAN3, bit 3 = LAN4, bit 4 = LAN5, bit 5 = LAN6, bit 6 = LAN7 */
#endif /* TOMATO64 */
#ifdef TCONFIG_IPV6
...
#else /* TOMATO64 */
	{ "smbd_protocol",		"4"				},	/* 0 - SMB1, 1 - SMB2, 2 - SMB1+SMB2, 3 - SMB3, 4 - SMB2+SMB3 (default), 5 - SMB1+SMB2+SMB3 */
#endif /* TOMATO64 */
...
/* bandwidth quotas (xt_bandwidth) */
	...
	{ "quota_nextid",		"1"				},
	{ "quota_path",			""				},
	{ "quota_stime",		"4"				},	/* save interval, hours */
#endif /* TOMATO64 */

#ifdef TCONFIG_NOCAT
	{ "NC_enable",			"0"				},	/* enable NoCatSplash */
	{ "NC_Verbosity",		"2"				},
	{ "NC_GatewayName",		"Tomato64 Captive Portal"	},
	{ "NC_GatewayPort",		"5280"				},
	{ "NC_GatewayMode",		"Open"				},
	...
	{ "nginx_fqdn",			"Tomato64"			},	/* server name */
 ...
 BRIDGE_BLOCK(15)
  ...
  WG_BLOCK(7)
	...
	{ "lan_ifnames",		"eth1 eth2 eth3 eth4 eth5 eth6 eth7 eth8"	},
#endif /* TOMATO64_X86_64 || TOMATO64_ARMSR */
#ifdef TOMATO64_MT6000
	{ "lan_ifnames",		"eth1 eth2 eth3 eth4 eth5"	},
	...
	{"wifi_phy_count_expected",	"2"				},	/* BPI-R3 Mini: 2.4GHz + 5GHz */
#elif defined(TOMATO64_RPI4)
	{"wifi_phy_count_expected",	"1"				},	/* RPI4: single dual-band PHY (2.4GHz + 5GHz) */
#elif defined(TOMATO64_R6S)
	{"wifi_phy_count_expected",	"0"				},	/* R6S: no built-in WiFi */
#elif defined(TOMATO64_R5S)
	{"wifi_phy_count_expected",	"0"				},	/* R5S: no built-in WiFi */
	...
	{"wifi_phy_count_expected",	"0"				},	/* armsr: ARM64 SystemReady, optional USB WiFi */
#else
	{"wifi_phy_count_expected",	"0"				},	/* Unknown device: no wifi by default */
#endif
...
#endif
	{"wifi_phy0iface0_mode",	"ap"				},
	{"wifi_phy0iface0_essid",	"Tomato64"			},
	{"wifi_phy0iface0_bssid",	""				},
	{"wifi_phy0iface0_network",	"br0"				},
	{"wifi_phy0iface0_hidden",	""				},
	{"wifi_phy0iface0_wmm",		"1"				},
	{"wifi_phy0iface0_uapsd",	"1"				},
	{"wifi_phy0iface0_encryption",	"psk2"				},
	{"wifi_phy0iface0_cipher",	"auto"				},
	{"wifi_phy0iface0_key",		"glmt6000"			},
	{"wifi_phy0iface0_isolate",	""				},
	{"wifi_phy0iface0_br_isolate",	""				},
	{"wifi_phy0iface0_ifname",	""				},
	{"wifi_phy0iface0_macfilter",	""				},
	{"wifi_phy0iface0_maclist",	""				},
	{"wifi_phy0iface0_custom",	""				},
	{"wifi_phy0iface0_mesh_fwding",	"1"				},
	{"wifi_phy0iface0_mesh_rssi_threshold", "0"			},
	{"wifi_phy0iface0_ieee80211r",			"0"		},
	{"wifi_phy0iface0_nasid",			""		},
	{"wifi_phy0iface0_mobility_domain",		""		},
	{"wifi_phy0iface0_reassociation_deadline",	""		},
	{"wifi_phy0iface0_ft_over_ds",			"0"		},
	{"wifi_phy0iface0_ft_psk_generate_local",	"1"		},
	{"wifi_phy0iface0_r0_key_lifetime",		""		},
	{"wifi_phy0iface0_r1_key_holder",		""		},
	{"wifi_phy0iface0_pmk_r1_push",			"0"		},
	{"wifi_phy0iface0_r0kh",			""		},
	{"wifi_phy0iface0_r1kh",			""		},
	{"wifi_phy0iface0_ieee80211k",			"0"		},
	{"wifi_phy0iface0_rrm_neighbor_report",		"1"		},
	{"wifi_phy0iface0_rrm_beacon_report",		"1"		},
	{"wifi_phy0iface0_time_advertisement",		"0"		},
	{"wifi_phy0iface0_time_zone",			""		},
	{"wifi_phy0iface0_wnm_sleep_mode",		"0"		},
	{"wifi_phy0iface0_wnm_sleep_mode_no_keys",	"0"		},
	{"wifi_phy0iface0_bss_transition",		"0"		},
	{"wifi_phy0iface0_proxy_arp",			"0"		},

	/* phy0 ifaces 1-15: generic disabled defaults */
	WIFI_DEF_PHY0_IFACES_1_15

	/* PHY1: 5GHz band, all 16 ifaces generic */
#if WIFI_PHY_COUNT >= 2
	WIFI_DEF_PHY_BLOCK(1, "5g", "80")
