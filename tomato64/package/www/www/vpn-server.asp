...
/* TOMATO64-REMOVE-END */
/* TOMATO64-BEGIN */
//	<% nvram("vpn_server_eas,vpn_server_dns,vpn_server1_poll,vpn_server1_if,vpn_server1_proto,vpn_server1_port,vpn_server1_firewall,vpn_server1_sn,vpn_server1_nm,vpn_server1_local,vpn_server1_remote,vpn_server1_dhcp,vpn_server1_r1,vpn_server1_r2,vpn_server1_crypt,vpn_server1_comp,vpn_server1_digest,vpn_server1_cipher,vpn_server1_ncp_ciphers,vpn_server1_reneg,vpn_server1_hmac,vpn_server1_plan,vpn_server1_plan1,vpn_server1_plan2,vpn_server1_plan3,vpn_server1_plan4,vpn_server1_plan5,vpn_server1_plan6,vpn_server1_plan7,vpn_server1_ccd,vpn_server1_c2c,vpn_server1_ccd_excl,vpn_server1_ccd_val,vpn_server1_pdns,vpn_server1_rgw,vpn_server1_userpass,vpn_server1_nocert,vpn_server1_users_val,vpn_server1_custom,vpn_server1_static,vpn_server1_ca,vpn_server1_ca_key,vpn_server1_crt,vpn_server1_crl,vpn_server1_key,vpn_server1_dh,vpn_server1_br,vpn_server1_ecdh,vpn_server2_poll,vpn_server2_if,vpn_server2_proto,vpn_server2_port,vpn_server2_firewall,vpn_server2_sn,vpn_server2_nm,vpn_server2_local,vpn_server2_remote,vpn_server2_dhcp,vpn_server2_r1,vpn_server2_r2,vpn_server2_crypt,vpn_server2_comp,vpn_server2_digest,vpn_server2_cipher,vpn_server2_ncp_ciphers,vpn_server2_reneg,vpn_server2_hmac,vpn_server2_plan,vpn_server2_plan1,vpn_server2_plan2,vpn_server2_plan3,vpn_server2_plan4,vpn_server2_plan5,vpn_server2_plan6,vpn_server2_plan7,vpn_server2_ccd,vpn_server2_c2c,vpn_server2_ccd_excl,vpn_server2_ccd_val,vpn_server2_pdns,vpn_server2_rgw,vpn_server2_userpass,vpn_server2_nocert,vpn_server2_users_val,vpn_server2_custom,vpn_server2_static,vpn_server2_ca,vpn_server2_ca_key,vpn_server2_crt,vpn_server2_crl,vpn_server2_key,vpn_server2_dh,vpn_server2_br,vpn_server2_ecdh,vpn_server3_poll,vpn_server3_if,vpn_server3_proto,vpn_server3_port,vpn_server3_firewall,vpn_server3_sn,vpn_server3_nm,vpn_server3_local,vpn_server3_remote,vpn_server3_dhcp,vpn_server3_r1,vpn_server3_r2,vpn_server3_crypt,vpn_server3_comp,vpn_server3_digest,vpn_server3_cipher,vpn_server3_ncp_ciphers,vpn_server3_reneg,vpn_server3_hmac,vpn_server3_plan,vpn_server3_plan1,vpn_server3_plan2,vpn_server3_plan3,vpn_server3_plan4,vpn_server3_plan5,vpn_server3_plan6,vpn_server3_plan7,vpn_server3_ccd,vpn_server3_c2c,vpn_server3_ccd_excl,vpn_server3_ccd_val,vpn_server3_pdns,vpn_server3_rgw,vpn_server3_userpass,vpn_server3_nocert,vpn_server3_users_val,vpn_server3_custom,vpn_server3_static,vpn_server3_ca,vpn_server3_ca_key,vpn_server3_crt,vpn_server3_crl,vpn_server3_key,vpn_server3_dh,vpn_server3_br,vpn_server3_ecdh,vpn_server4_poll,vpn_server4_if,vpn_server4_proto,vpn_server4_port,vpn_server4_firewall,vpn_server4_sn,vpn_server4_nm,vpn_server4_local,vpn_server4_remote,vpn_server4_dhcp,vpn_server4_r1,vpn_server4_r2,vpn_server4_crypt,vpn_server4_comp,vpn_server4_digest,vpn_server4_cipher,vpn_server4_ncp_ciphers,vpn_server4_reneg,vpn_server4_hmac,vpn_server4_plan,vpn_server4_plan1,vpn_server4_plan2,vpn_server4_plan3,vpn_server4_plan4,vpn_server4_plan5,vpn_server4_plan6,vpn_server4_plan7,vpn_server4_ccd,vpn_server4_c2c,vpn_server4_ccd_excl,vpn_server4_ccd_val,vpn_server4_pdns,vpn_server4_rgw,vpn_server4_userpass,vpn_server4_nocert,vpn_server4_users_val,vpn_server4_custom,vpn_server4_static,vpn_server4_ca,vpn_server4_ca_key,vpn_server4_crt,vpn_server4_crl,vpn_server4_key,vpn_server4_dh,vpn_server4_br,vpn_server4_ecdh,lan_ifname,lan1_ifname,lan2_ifname,lan3_ifname,lan4_ifname,lan5_ifname,lan6_ifname,lan7_ifname"); %>
/* TOMATO64-END */
...
/* TOMATO64-BEGIN */
		fom['vpn_'+t+'_plan4'].value = E('_f_vpn_'+t+'_plan4').checked ? 1 : 0;
		fom['vpn_'+t+'_plan5'].value = E('_f_vpn_'+t+'_plan5').checked ? 1 : 0;
		fom['vpn_'+t+'_plan6'].value = E('_f_vpn_'+t+'_plan6').checked ? 1 : 0;
		fom['vpn_'+t+'_plan7'].value = E('_f_vpn_'+t+'_plan7').checked ? 1 : 0;
/* TOMATO64-END */
...
/* TOMATO64-BEGIN */
			W('<input type="hidden" name="vpn_'+t+'_plan4">');
			W('<input type="hidden" name="vpn_'+t+'_plan5">');
			W('<input type="hidden" name="vpn_'+t+'_plan6">');
			W('<input type="hidden" name="vpn_'+t+'_plan7">');
/* TOMATO64-END */
