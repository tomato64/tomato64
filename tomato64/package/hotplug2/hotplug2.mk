...
define HOTPLUG2_INSTALL_STAGING_CMDS
	...
	$(INSTALL) -D -m 0644 $(@D)/examples/hotplug2.rules-2.6kernel $(STAGING_DIR)/etc/hotplug2.rules
endef

define HOTPLUG2_INSTALL_TARGET_CMDS
	$(INSTALL) -D -m 0755 $(@D)/hotplug2 $(TARGET_DIR)/sbin
	$(INSTALL) -D -m 0644 $(@D)/examples/hotplug2.rules-2.6kernel $(TARGET_DIR)/etc/hotplug2.rules
endef
